...
public class ElementsDecorator1 extends DefaultFieldDecorator {
    private WebDriver webDriver;

    public ElementsDecorator1(ElementLocatorFactory factory, WebDriver driver) {
        super(factory);
    ...
    private boolean isCustomElement(Field field) {
        return CustomElement1.class.isAssignableFrom(field.getType());
    }

...
public class CommandExecutor {
    ...
    public ExecutionResult execute(String command, String workingDirectory, long timeoutMillis) throws Exception {
        ...
        if (!finished) {
            ...
            throw new Exception("Command execution timed out after " + timeoutMillis + "ms");
        }

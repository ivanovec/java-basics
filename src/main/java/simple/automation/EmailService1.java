...
public class EmailService1 {
    ...
    public EmailService1(String fromAddress, boolean enabled) {
    ...
    public void sendAccountDeactivationEmail(User1 user, String reason) {
        if (!enabled) {
            return;
        }
    ...
    public void sendRoleChangeEmail(User1 user, UserRole1 newRole) {
        if (!enabled) {
            return;
        }
    ...
    public void sendPasswordResetEmail(User1 user, String resetToken) {
        if (!enabled) {
            return;
        }
